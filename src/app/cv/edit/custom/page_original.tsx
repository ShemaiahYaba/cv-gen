...
const initialData = {
  ...
  summaryInputs: {
    ...
    strength3:
      "leading small engineering teams to deliver high-impact features",
  },
  skills: {
  ...
  projects: [
    {
      ...
      description:
        "Built an NLP-based system that automatically prioritizes tasks.",
  ...
  leadership: [
    {
      ...
      dates: "2020 – 2021",
      impact:
        "Organized weekly workshops and a university-wide hackathon, growing club membership by 50%.",
    },
  ],
};
...
export default function CustomCvEditorPage() {
  ...
  const [summaryInputs, setSummaryInputs] = useState<SummaryInputs>(
    initialData.summaryInputs
  );
      ...
      <div className="flex-1 grid md:grid-cols-2 overflow-hidden">
        ...
        <aside className={cn(
          ...
          >
              ...
              <AccordionContent className="space-y-4 pt-4">
                <div className="grid gap-2">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      setSummaryInputs((s) => ({ ...s, role: e.target.value }))
                    }
                  />
                </div>
                <div className="grid gap-2">
                  ...
                  <Input
                    ...
                    value={summaryInputs.experience}
                    onChange={(e) =>
                      setSummaryInputs((s) => ({
                        ...s,
                ...
                <div className="grid gap-2">
                  <Label>Top Strength/Skill #1</Label>
                  <Input
                    placeholder="e.g., building scalable APIs"
                    value={summaryInputs.strength1}
                    onChange={(e) =>
                      setSummaryInputs((s) => ({
                        ...s,
                        strength1: e.target.value,
                      }))
                    }
                  />
                </div>
                <div className="grid gap-2">
                  <Label>Top Strength/Skill #2</Label>
                  <Input
                    placeholder="e.g., optimizing database performance"
                    value={summaryInputs.strength2}
                    onChange={(e) =>
                      setSummaryInputs((s) => ({
                        ...s,
                        strength2: e.target.value,
                      }))
                    }
                  />
                </div>
                <div className="grid gap-2">
                  <Label>Top Strength/Skill #3</Label>
                  <Input
                    placeholder="e.g., mentoring junior developers"
                    value={summaryInputs.strength3}
                    onChange={(e) =>
                      setSummaryInputs((s) => ({
                        ...s,
                        strength3: e.target.value,
                      }))
                    }
                  />
                </div>
            ...
            <AccordionItem value="skills">
              ...
              <AccordionContent className="space-y-4 pt-4">
                <div className="grid gap-2">
                  <Label>Technical Skills (Languages)</Label>
                  <Textarea
                ...
                <div className="grid gap-2">
                  ...
                  <Textarea
                    placeholder="Comma-separated, e.g., React, Docker"
                    value={skills.tools}
                    onChange={(e) =>
                ...
                <div className="grid gap-2">
                  <Label>Workflow & Practices</Label>
                  <Textarea
                    placeholder="Comma-separated, e.g., Agile, CI/CD"
                    value={skills.workflow}
                    onChange={(e) =>
                      setSkills((s) => ({ ...s, workflow: e.target.value }))
                    }
                    rows={2}
                  />
                </div>
                ...
                {experiences.map((exp, i) => (
                  ...
                  >
                    <Button
                      ...
                      onClick={() => removeListItem(setExperiences, i)}
                    >
                      ...
                      {exp.bullets.map((bullet, bulletIndex) => (
                        ...
                        >
                          <Textarea
                            value={bullet}
                            onChange={(e) =>
                              handleBulletChange(i, bulletIndex, e.target.value)
                            }
                            rows={2}
                            placeholder="Action Verb → What you did → Quantified outcome"
                          />
                          <Button
                            variant="ghost"
                            size="icon"
                            className="shrink-0"
                            onClick={() => removeBullet(i, bulletIndex)}
                          >
                            <Trash2 className="w-4 h-4 text-destructive" />
                          </Button>
                        </div>
              ...
              <AccordionContent className="space-y-6 pt-4">
                {projects.map((proj, i) => (
                  ...
                  >
                    ...
                    <div className="grid gap-2">
                      <Label>Quantified Outcome</Label>
                      <Textarea
                        value={proj.outcome}
                        onChange={(e) =>
                          handleListChange(
        ...
        <main className={cn(
          ...
          >
            ...
            {/* Summary */}
            <div className="mb-6">
              <h2 className="text-xs font-bold font-headline uppercase tracking-widest border-b-2 border-black pb-1 mb-2">
            ...
            <div className="mb-6">
              ...
              <div className="text-sm flex gap-x-4">
                <p>
                  <strong>Languages:</strong> {skills.technical}
                </p>
                <p>
                  <strong>Frameworks/Tools:</strong> {skills.tools}
                </p>
                <p>
                  <strong>Workflow:</strong> {skills.workflow}
                </p>
              </div>
            </div>
